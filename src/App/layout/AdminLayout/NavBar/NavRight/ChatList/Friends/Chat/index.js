        ...
        <Aux>
            <div className={chatClass.join(' ')}>
                <div className="h-list-header">
                    ...
                    <a href={CONST_APP.BLANK_LINK} className="h-back-user-list" onClick={props.closed}><i className="feather icon-chevron-left" /></a>
                </div>
                ...
                <div className="h-list-footer">
                    <div className="input-group">
                        ...
                        <a href={CONST_APP.BLANK_LINK} className="input-group-prepend btn btn-success btn-attach">
