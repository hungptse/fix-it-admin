            ...
            <Aux>
                <Row>
                    <Col sm={12}>
                        ...
                        <Card>
                            <Card.Header>
                                <Button href={CONST_APP.BLANK_LINK} onClick={() => this.setState({ isBasic: !isBasic })} aria-controls="basic-collapse" aria-expanded={isBasic}>Collapse Link</Button>
